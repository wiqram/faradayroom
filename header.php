      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-10 col-xs-10">
            <h1 class="logo"> <a href="index.php"><img src="images/Faraday Room Logo 5s.png" alt="Logo">Make yourself invisible from the prying eyes on the Internet</a></h1>
          </div>
          <!-- <div class="col-xs-7">
