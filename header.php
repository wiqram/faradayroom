      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-10 col-xs-10">
            <h1 class="logo"> <a href="index.php"><img src="images/Predictonomy Logo Official v0.3.png" alt="Logo">Make yourself invisible from the prying eyes on the Internet</a></h1>
          </div>
          <!-- <div class="col-xs-7">
          ...
          <div class="col-md-12">
            <nav class="navigation">
              <ul class="sf-menu">
                ...
                <li><a href="about.php">Countries</a>
				<ul class="dropdown">
                    <li><a href="our-excos.php">UK</a></li>
                    <li><a href="our-excos.php">USA</a></li>
                    <li><a href="our-excos.php">India</a></li>
                    <!-- </li>
