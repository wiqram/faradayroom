      ...
      <div class="row">
        <div class="col-md-12">
          <ol class="breadcrumb">
            ...
            <li class="active">National Executives</li>
          </ol>
        </div>
      </div>
    </div>
  ...
  <div class="main" role="main">
              ...
              <section class="listing-cont">
				...
				<?php                     
                            if(!isset($_GET["page"])){
                                ...
                                $tbl_name="excos";		//your table name
	...
	/* Get data. */
				...
				//$news->execute();
	                          ...
	                          $news = ORM::for_table("excos")
                                          ->limit($limit)
                                          ->offset($start)
                                          ->order_by_desc('excos.id')
                                           ->find_array();
	 ...
	 ?>
				<li class="item event-item">
                    <div class="event-detail">
                      <h4><?php echo $row['name'];?></h4> <?php echo $row['office'];?>
                      <span class="event-dayntime meta-data"><?php echo $row['phone'];?> | <?php echo $row['email'];?></span>
                      </div>
                    </li>
					<?php endforeach;?>	 
